...
public class Test1Servlet extends HttpServlet {
     ...
     *  - 또한 사용자가 요청하는 정보가 주소창에 노출되는 것을 막고자 할 때 많이 사용한다  (INSERT / UPDATE / DELETE)
     */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 3. 웹 페이지로 표현할 정보 입력
		out.println("<html><head><title>서블릿이란?</title></head><body>");
		out.println("<h1>서블릿이란?</h1>");
		out.println("<h3>서블릿은 웹 애플리케이션으로 보여질 소스 코드나 특정 구문을 자바 언어를 통해 구현하는 기술을 말한다</h3>");
